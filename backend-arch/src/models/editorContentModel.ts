...
export interface EditorContentModel {
  ...
  findLatestByBoardMeeting(boardMeetingId: string): Promise<EditorContent | null>;
...
export class EditorContentModelImpl implements EditorContentModel {
  ...
  async findById(id: string): Promise<EditorContent | null> {
    const findByIdValidator = Prisma.validator<Prisma.EditorContentFindUniqueArgs>()({
      where: { id },
      include: {
        boardMeeting: {
          select: {
  ...
  async findByBoardMeeting(boardMeetingId: string): Promise<EditorContent[]> {
    const findByBoardMeetingValidator = Prisma.validator<Prisma.EditorContentFindManyArgs>()({
  ...
  async findLatestByBoardMeeting(boardMeetingId: string): Promise<EditorContent | null> {
    const findLatestValidator = Prisma.validator<Prisma.EditorContentFindFirstArgs>()({
      where: { boardMeetingId },
      include: {
        boardMeeting: {
          select: {
  ...
  async update(id: string, data: UpdateEditorContentData): Promise<EditorContent> {
